...
class KostMahal extends StatefulWidget {
  @override
  _KostMahalState createState() => _KostMahalState();
}

class _KostMahalState extends State<KostMahal> {
  @override
  ...
  Future<List> getData() async {
    final response = await http.get(BaseUrl.lihatprodukmahal);
