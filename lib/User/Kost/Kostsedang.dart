...
class Kostsedang extends StatefulWidget {
  @override
  _KostsedangState createState() => _KostsedangState();
}

class _KostsedangState extends State<Kostsedang> {
  @override
  ...
  Future<List> getData() async {
    final response = await http.get(BaseUrl.lihatproduksedang);
